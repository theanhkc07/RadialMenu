...
namespace RadialMenuPlugin.Controls.Buttons.Shaped.Form.Center
{
    ...
    public class FormCenterButton : ShapedButton
    {
        ...
        protected void SwapTooltips(Action[] animators)
        {
            ...
            {
                Buttons[CurrentDisplayedTooltip].Alpha = 0;
            ...
            Buttons[CurrentDisplayedTooltip].Alpha = 1;
        }
        ...
        {
            Buttons[FormCenterTooltipNames.Tooltip1].Alpha = 0;
            Buttons[FormCenterTooltipNames.Tooltip2].Alpha = 0;
        }
        /// <summary>
